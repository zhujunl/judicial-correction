...
public class LiveTokenCallAdapterFactory  extends CallAdapter.Factory {
    ...
    public CallAdapter<?, ?> get(@NonNull Type returnType, @NonNull Annotation[] annotations, @NonNull Retrofit retrofit) {
        ...
        if (rawObservableType != TokenResult.class) {
        ...
        return new LiveTokenCallAdapter<>(observableType);
    }
}